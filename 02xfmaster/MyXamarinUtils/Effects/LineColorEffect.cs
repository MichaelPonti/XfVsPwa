...
namespace MyXamarinUtils.Effects
{
	public static class LineColorEffect
	{
		...
		{
			public EntryLineColorEffect() : base("MyXamarinUtils.EntryLineColorEffect")
			{
			}
		}
		...
		{
			public DatePickerLineColorEffect() : base("MyXamarinUtils.DatePickerLineColorEffect")
			{
			}
		}
		...
		{
			public PickerLineColorEffect() : base("MyXamarinUtils.PickerLineColorEffect")
			{
			}
		}
	}
